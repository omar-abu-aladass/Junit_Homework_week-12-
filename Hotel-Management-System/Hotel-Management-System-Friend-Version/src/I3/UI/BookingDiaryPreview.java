 ...
 */
public class BookingDiaryPreview extends javax.swing.JFrame {

    /**
     * Creates new form BookingDiaryPreview
     */
    Date first,last;
    public BookingDiaryPreview() {
        initComponents();
        first = new Date();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookingDiaryPreview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookingDiaryPreview().setVisible(true);
            }
        });
    }
